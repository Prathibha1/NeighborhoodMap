    ...
    self.listedlocations().forEach(function(locationlist) {
        ...
        marker.addListener('click', function() {
           ...
           // $.ajax({
               ...
               // url: 'http://api.openweathermap.org/data/2.5/weather?q=' + locationlist.title() + '&lat=' + locationlist.lat() + '&lon=' + locationlist.lng() + '&APPID=a2201174489617c41c67c0667e1748ef',
               /* dataType: "json",
                success: function(data) {
                 ...
                 infoWindow.setContent('<p>' + locationlist.title() + '</p>' + '<h4>' + locationlist.info() + '</h4>');
